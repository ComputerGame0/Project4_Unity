        ...
        for (int x = 0; x < gridSize; x++) {
            for (int y = 0; y < gridSize; y++) {
                ...
                else
                {
                    ...
                    if (count % 2 == 0)
                    {
                        bufferOld[x, y] = random.NextDouble() < randomFillPercent ? 2:0;
                    }
                    else
                    {
                        bufferOld[x, y] = random.NextDouble() < randomFillPercent ? 0:2;
                    }
                }
                count = count + 1;
            }
    ...
    public void SmoothMap()   {
        for (int x = 0; x < gridSize; x++) {
            for (int y = 0; y < gridSize; y++) {
                ...
                int surroundingfloors = GetSurroundingfloorCount(x, y);
                ...
                else if (surroundingWalls == 4 || surroundingfloors == 4)
                {
